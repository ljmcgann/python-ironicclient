...
class Resource(object):
    ...
    FIELDS = {
        ...
        'default_security_interface': 'Default Security Interface',
        ...
        'enabled_security_interfaces': 'Enabled Security Interfaces',
        ...
        'security_interface': 'Security Interface',
        'state': 'State',
        'steps': 'Steps',
